...
async def clone_menu(client, message):
    ...
    if await db.is_clone_exist(message.from_user.id):
        return await message.reply("**Yᴏᴜ Hᴀᴠᴇ Aʟʀᴇᴀᴅʏ Cʟᴏɴᴇᴅ A Bᴏᴛ Dᴇʟᴇᴛᴇ Fɪʀsᴛ Iᴛ Bʏ /deleteclone**")
    else:
        pass
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @Mr_Official_300 to get assistance.**")
